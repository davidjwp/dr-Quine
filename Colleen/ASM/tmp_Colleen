section .data
	...
	10,'	mov rbx, qn@',10,'	mov rsi, p_quo@',10,'	call write@',10,'	jmp end_cond!',10,10,'end_print:@',10,'	mov rsi, p_end@',10,'	call write_loop@',10,'	lea rbx, [qn + 24]#',\
	10,'	mov [is_print], byte 0@',10,'	jmp end_cond!',10,10,'_start:@',10,'	mov [is_print], byte 0@',10,'	mov [msg], byte 0@',10,'	mov rbx, qn@',10,'	mov rax, 1@',10,'	mov rdi, 1#',\
	10,'	mov rdx, 1!',10,10,'	loop: &',47,42,10,'	comment&',10,42,47,10,'		cmp [rbx], byte 33@',10,'		je p_33@',10,'		cmp [rbx], byte 38@',10,'		je p_38#',\
	...
	10,'		jnz end_print!',10,10,'		&',47,42,10,'	comment&',10,42,47,10,'		mov rax, 60@',10,'		xor rdi, rdi@',10,'		syscall',0
