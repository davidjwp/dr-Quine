section .data
	qn db 'section .data@',10,'	qn db Q@',10,'	p_fl db 83,117,108,108,121,95,46,99,0@',10,'	p_nl db 64,39,44,49,48,44,39,0#',\
	10,'	p_pnl db 35,39,44,92,10,9,49,48,44,39,0@',10,'	p_dnl db 33,39,44,49,48,44,49,48,44,39,0@',10,'	p_quo db 39,0#',\
	10,'	p_end db 39,44,48,0!',10,10,'section .bss@',10,'	is_print resb 1@',10,'	msg resb 1!',10,10,'section .text#',\
	...
	10,'	call write_loop@',10,'	lea rbx, [qn + 40]@',10,'	mov [is_print], byte 0@',10,'	jmp end_cond!',10,10,'_start:@',10,'	mov rax, 2#',\
	10,'	mov rdi, p_fl@',10,'	mov rsi, 02 | 0100@',10,'	mov rdx, 0422@',10,'	syscall!',10,10,'	mov [is_print], byte 0#',\
	10,'	mov rbx, qn@',10,'	mov rdi, rax@',10,'	mov rax, 1@',10,'	mov rdx, 1!',10,10,'	loop:@',10,'		cmp [rbx], byte 33#',\
	10,'		je p_33@',10,'		cmp [rbx], byte 35@',10,'		je p_35@',10,'		cmp [rbx], byte 64@',10,'		je p_64#',\
