section .data
	qn db 'section .data@',10,'	qn db Q@',10,'	p_fl db 46,47,71,114,97,99,101,95,107,105,100,46,115,0@',10,'	p_nl db 64,39,44,49,48,44,39,0@',10,'	p_pnl db 35,39,44,92,10,9,49,48,44,39,0@',10,'	p_dnl db 33,39,44,49,48,44,49,48,44,39,0#',\
	...
	10,'	mov [msg], byte 0@',10,'	mov rbx, qn@',10,'	mov rdi, rax@',10,'	mov rax, 1@',10,'	mov rdx, 1!',10,10,'	loop:@',10,'		cmp [rbx], byte 33@',10,'		je p_33@',10,'		cmp [rbx], byte 35@',10,'		je p_35@',10,'		cmp [rbx], byte 64@',10,'		je p_64@',10,'		cmp [rbx], byte 81@',10,'		je p_81!',10,10,'		end_cond:!',10,10,'		mov rsi, rbx@',10,'		call write#',\
	...
	p_fl db 83,117,108,108,121,95,46,99,0
